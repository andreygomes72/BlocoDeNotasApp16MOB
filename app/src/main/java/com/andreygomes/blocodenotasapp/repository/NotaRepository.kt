package com.andreygomes.blocodenotasapp.repository

import com.andreygomes.blocodenotasapp.api.getNotaAPI
    ...
    fun salvar(nota: Nota,
        ...
        getNotaAPI()
                ...
                .enqueue(object : Callback<Nota>{
                    override fun onFailure(call: Call<Nota>?,
                                           t: Throwable?) {
                        onError(t)
                    }

                    override fun onResponse(call: Call<Nota>?,
