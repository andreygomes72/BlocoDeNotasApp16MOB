...
import com.andreygomes.blocodenotasapp.R
import com.andreygomes.blocodenotasapp.model.Nota
import com.andreygomes.blocodenotasapp.view.formulario.FormularioActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            startActivityForResult(formularioIntent,
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            R.id.action_settings -> {
                startActivityForResult(Intent(this, FormularioActivity::class.java), 1)
                true
            }
